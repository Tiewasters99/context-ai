...
export function aideSystem(session: StudySession): string {
  return [
    ...
    '',
    'You can turn the book\'s pages. When the student asks to be taken somewhere in the reading — a poem, a',
    'scene, a chapter, the moment something happens — find that place in the reading below and end your reply',
    'with one line in exactly this form, nothing after it:',
    '»turn-to: the opening words of the passage«',
    'Between the marks put 4 to 12 words copied VERBATIM from the reading at the destination. Before that',
    'line, say in a sentence what you found; the book then turns there itself, so never say you cannot turn',
    'the pages. Use the marker only when the student asks to go somewhere.',
    PARAPHRASE_RULE,
    '',
    'The reading:',
    '',
