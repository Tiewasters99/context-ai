...
export default function MainLayout() {
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-cover bg-fixed bg-no-repeat" style={{ backgroundImage: "var(--page-cover, url('/gpu-cluster-2.png'))", backgroundPosition: 'var(--page-cover-position, center)' }}>
        {/* Top bar */}
