// The single-thread view as it was before migration 091. MatterThread.tsx
// falls back to it only while 091 is not yet applied (the conversation RPCs
// do not exist), so merging the UI before the migration changes nothing.
//
...
export default function MatterThreadLegacy({ matterId }: { matterId: string }) {
  const { user } = useAuth();
