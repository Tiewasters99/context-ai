 ...
 * Neutral since 2026-09-23 (it said "the transcript's printed page"): printed
 * pages now also come from Westlaw's star pages (lib/westlaw-pages.mjs).
 * Westlaw never writes the declined state — it claims a page or writes nothing.
 */
export const PDF_INDEX_CAVEAT =
  "PDF page; the printed page was not confirmed";
