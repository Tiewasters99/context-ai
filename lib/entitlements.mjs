...
// ---------------------------------------------------------------------------
// The meter fails soft — to a bounded outage ceiling (lib/usage-meter.mjs
// DEGRADED_CEILING), never to a refusal of free reads or of workshop: refusing
// a lawyer's work to protect a budget is the worse failure, and a request let
// through costs cents. An entitlement that
