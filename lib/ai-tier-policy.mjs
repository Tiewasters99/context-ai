...
//     record is now the same model via Bedrock (provider 'aws-bedrock') —
//     contractual zero retention in our own AWS account, verified against
//     AWS's data-retention docs 2026-08-27 (Opus 4.8 allowed_modes includes
//     'none'; under mode none, Messages requests are never retained and the
//     account structurally cannot invoke a retention-requiring model). Once
