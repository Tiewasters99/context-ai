...
const SUPPORTED_TYPES_BASE =
  'PDF, Word (.docx, .rtf), text (.txt, .md, .csv, .html), spreadsheets (.xlsx), ' +
...
// .doc / .xls / .ppt — the pre-2007 binary Office formats (OLE compound
//   files). Nothing in package.json parses them: mammoth reads .docx only,
//   SheetJS is wired for .xlsx here. Word/Excel/PowerPoint all still open
//   them and Save As the modern format.
...
export const UNSUPPORTED_HINTS = Object.freeze({
  ...
  '.doc': ' Save the legacy Word file as .docx and upload that.',
