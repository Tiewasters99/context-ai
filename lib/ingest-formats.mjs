...
export const UNSUPPORTED_HINTS = Object.freeze({
  '.heic': ' iPhone photos saved in High Efficiency format cannot be opened here.' +
    ...
    ' For a photo you already have, share it (Mail, Files, AirDrop) — iOS converts it to JPEG — and upload that.',
  ...
  '.msg': ' Outlook\'s own message format cannot be opened here. Export the email as .eml' +
    ' (in Outlook, drag it to a folder on the desktop), or print it to PDF, and upload that —' +
    ' attachments can be uploaded on their own.',
