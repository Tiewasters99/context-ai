...
//   B (sealed)   → Claude Opus 4.8 via Bedrock (the bedrock-mantle
...
export const PENS = {
  ...
  bedrock: {
    ...
    // model ids carry no version suffix. Served from the REGIONAL endpoint
    ...
    label: 'Claude Opus 4.8 (Bedrock, our AWS account, zero retention)',
